...
export const VEHICLES = [
  { id: "plane", name: "Aerion", description: "Twin-engine touring jet", type: "plane",
    uri: "assets/aerion.glb?v=fleet8", preview: "assets/aerion-preview.png?v=fleet8", scale: .86, yaw: -90, pitch: 0, roll: 0,
  ...
  { id: "spaceship", name: "Wayfarer", description: "Ion-powered atmospheric explorer", type: "spaceship",
    uri: "assets/wayfarer.glb?v=fleet8", preview: "assets/wayfarer-preview.png?v=fleet8", scale: .86, yaw: -90, pitch: 0, roll: 0,
  ...
  { id: "cyberwing", name: "Cyberwing", description: "Neon stealth interceptor", type: "plane",
    uri: "assets/cyberwing.glb?v=cyber3", preview: "assets/cyberwing-preview.png?v=cyber3", scale: .8, yaw: -90, pitch: 0, roll: 0,
